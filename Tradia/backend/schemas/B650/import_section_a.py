...
class B650SectionAHeader(BaseModel):
    ...
    contact_details: Optional[str] = Field(None, description="Contact details (email/phone)")
    ...
    valuation_elements: Optional[str] = Field(None, description="Valuation elements description")
